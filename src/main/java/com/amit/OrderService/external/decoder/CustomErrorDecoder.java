package com.amit.OrderService.external.decoder;

import com.amit.OrderService.exception.CustomException;
...
public class CustomErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        ...
        try {
            ErrorResponse errorResponse = objectMapper.readValue(response.body().asReader(), ErrorResponse.class);
